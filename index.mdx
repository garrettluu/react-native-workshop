...
<CheckInButton code='reACT' />

---

# About these slides...

- These slides were made using [mdx-deck](https://github.com/jxnblk/mdx-deck).
...
- Will be **deprecated** from React eventually ⚰️
...
## The cooler way to write components 😎
